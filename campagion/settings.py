"""
Django settings for campagion project.
...
MIDDLEWARE = [
    ...
    'main.contrib.middleware.AuthenticationMiddleware'
]

ROOT_URLCONF = 'campagion.urls'
...
WSGI_APPLICATION = 'campagion.wsgi.application'


# Database
# https://docs.djangoproject.com/en/3.2/ref/settings/#databases

if config('SQLITE', cast=bool):
    DATABASES = {
        'default': {
